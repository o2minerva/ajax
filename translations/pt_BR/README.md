...
Para criar uma instância de XHR, você simplesmente precisa obter um nome de variável, e usar o método `new XMLHttpRequest()` para criar a instância. Então, vamos criar uma instância da seguinte forma:
